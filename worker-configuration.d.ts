/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1e2a9fb34b4b0307a718dc06d53fb1fc)
// Runtime types generated with workerd@1.20250525.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENV_BASE_URL: "https://ramen-api.dev/";
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").RamenMcp>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV_BASE_URL">> {}
}
